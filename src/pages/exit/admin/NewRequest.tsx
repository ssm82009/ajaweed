...
export default function NewRequest() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await axios.post('/api/exit/permissions', {
    ...
    React.useEffect(() => {
        const fetchFilters = async () => {
            try {
                const token = localStorage.getItem('token');
                const res = await axios.get('/api/exit/students/filters', { headers: { Authorization: `Bearer ${token}` } });
                setFilters(res.data);
    ...
    const search = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await axios.get(`/api/exit/students/search?${params}`, {
                headers: { Authorization: `Bearer ${token}` }
            });
            setResults(res.data);
            setSelectedStudent(null);
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            const resFilters = await axios.get('/api/exit/students/filters', { headers: { Authorization: `Bearer ${token}` } });
